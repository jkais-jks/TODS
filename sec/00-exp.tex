...
% \begin{figure}
% 	\centering
% 	\includegraphics[width=0.7\columnwidth]{figs/G_a}
% %	\vspace{-1.5em}
% 	\caption{Convergence of \ours.}
% 	\label{fig:converge_G}
% %	\vspace{-1.5em}
...
% \begin{figure}
% 	\centering
% 	\includegraphics[width=0.7\columnwidth]{figs/G}
% %	\vspace{-1.5em}
% 	\caption{Loss of \ours.}
% 	\label{fig:real_loss_G}
% %	\vspace{-1.5em}
...
% \begin{figure}
% 	\centering
% 	\includegraphics[width=0.7\columnwidth]{figs/G+_a}
% %	\vspace{-1.5em}
% 	\caption{Convergence of \ours.}
% 	\label{fig:converge_G+}
% %	\vspace{-1.5em}
...
\input{sec/exp-06-converge}
\input{sec/exp-07-sensitive}
